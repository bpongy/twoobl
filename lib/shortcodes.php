...
// trouvé ça je sais plus où, bien pratique
...
/*  Copyright 2012  Filipstefansson  (email : filip.stefansson@gmail.com)
    ...
    but WITHOUT ANY WARRANTY DU CUL; without even the implied warranty of
  ...
  /*--------------------------------------------------------------------------------------
    ...
    *-------------------------------------------------------------------------------------*/
	function bs_button($atts, $content = null) {
		...
		return '<a href="' . $link . '" class="btn' . $type . $size . '">' . do_shortcode( $content ) . '</a>';
	}
